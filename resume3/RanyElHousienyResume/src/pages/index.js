    ...
    <div className="container-fluid p-0">
      ...
      >
        <div className="w-100">
          ...
          <a href="https://www.certmetrics.com/amazon/public/badge.aspx?i=1&t=c&d=2019-12-05&ci=AWS00871186">AWS Solutions Architect Certified </a>Commercial software development manager offering 15+ years’ managing cross-functional, global teams. Develops underperforming teams to have the ability to ship complex product releases significantly ahead of schedule.  Designed and implemented products used by 500M+ users Cross Platforms.  Gold Star Award Winner presented from VP of Microsoft for saving failing projects, moving them from failed to shipped with high quality, and Increasing products deployment speed by 70%.  Known and awarded for building high-performing teams. Awarded from the BOD of APFM for the high impact in the first 3 months
          </p>
      ...
      >
        ...
        <div className="resume-item d-flex flex-column flex-md-row justify-content-between">
            <div className="resume-content">
              ...
              <li>Gold Star Award Winner presented from VP of Microsoft for rapidly shipping a failing product.</li>
              </ul>
